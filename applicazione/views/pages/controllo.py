...
from struttura.strutturaC1 import FileC1, FileC1Repository, ControlloFileC1
from struttura.strutturaC2 import FileC2, FileC2Repository, ControlloFileC2
...
def show():
    ...
    with st.spinner('Caricamento file...'):
        ...
        tab_1, tab_2 = st.tabs(["File C1", "File C2"])
