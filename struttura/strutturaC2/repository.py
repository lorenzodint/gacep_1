...
from struttura.strutturaC2 import FileC2, RecordC2Builder, RecordC2
...
DEFINIZIONE_CAMPI = [
    ...
    ("codice_prestazione_cur", 183, 191),
    ("branca_specialistica", 191, 193),
    ("garanzia_tempi_massimi", 193, 194),
    ("numero_sedute_cliniche", 194, 197),
    ("data_prenotazione", 197, 205),
    ("data_prima_disponibilita", 205, 213),
    ("data_primo_appuntamento", 213, 221),
    ("tipo_prestazione", 221, 222),
]

LUNGHEZZA_ATTESA = 222
